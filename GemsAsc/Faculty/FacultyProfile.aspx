<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/FacultyMaster.Master" AutoEventWireup="true" CodeBehind="FacultyProfile.aspx.cs" Inherits="GemsAsc.Faculty.FacultyProfile" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnlProfile" runat="server" CssClass="profile-container">
        <div class="profile-card">
            ...
            <p><b>Designation:</b> <asp:Label ID="lblDesignation" runat="server"></asp:Label></p>
