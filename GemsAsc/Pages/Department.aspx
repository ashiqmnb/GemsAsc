<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Department.aspx.cs" Inherits="GemsAsc.Pages.Department" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        <asp:Label ID="lblName" runat="server" Font-Bold="True" CssClass="dept-title" /><br />
